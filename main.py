...
@click.command()
@click.option('--file', required=True, help='Location of the file that should be chunked.')
@click.option('--sheet-name', required=True, help='Name of the worksheet that should be read.')
@click.option('--chunk-size', default=1000, help='The max size of the newly created batch files.')
